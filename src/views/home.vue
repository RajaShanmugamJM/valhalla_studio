...
<template>
  <div class="relative w-screen h-screen overflow-hidden">
    ...
    <button
      ...
      class="btn-icon fixed bottom-6 right-6 z-[1000] w-12 h-12 rounded-full bg-surface shadow-lg active:scale-95 transition-all duration-150 focus:ring-2 focus:ring-offset-2 focus:ring-stroke-strong"
      aria-label="Open settings"
    >
      <!-- Settings gear SVG icon -->
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" class="w-6 h-6 text-ink-secondary">
        <path
